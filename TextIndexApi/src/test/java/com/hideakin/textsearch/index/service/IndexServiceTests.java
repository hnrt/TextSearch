...
public class IndexServiceTests {
	...
	public void updateIndex_successful_second() {
		...
		entity.setText(texts.get(0));
		entity.setDist(new byte[] { 13, 3, 0, 3, 5 });
		when(textRepository.findByText(texts.get(0))).thenReturn(entity);
		entity = new TextEntity();
		entity.setText(texts.get(1));
		entity.setDist(new byte[] { 13, 2, 1, 4 });
		when(textRepository.findByText(texts.get(1))).thenReturn(entity);
		entity = new TextEntity();
		entity.setText(texts.get(1));
		entity.setDist(new byte[] { 13, 1, 2 });
	...
	public void updateIndex_successful_overwrite() {
		...
		entity = new TextEntity();
		entity.setText(texts.get(0));
		entity.setDist(new byte[] { 17, 3, 0, 3, 5 });
		when(textRepository.findByText(texts.get(0))).thenReturn(entity);
		entity = new TextEntity();
		entity.setText(texts.get(1));
		entity.setDist(new byte[] { 17, 2, 1, 4 });
		when(textRepository.findByText(texts.get(1))).thenReturn(entity);
		entity = new TextEntity();
		entity.setText(texts.get(1));
		entity.setDist(new byte[] { 17, 1, 2 });
		when(textRepository.findByText(texts.get(2))).thenReturn(entity);
		when(textRepository.save(any(TextEntity.class))).thenReturn(null);
		UpdateIndexRequest req = new UpdateIndexRequest();
		req.setPath(path);
	...
	public void updateIndex_successful_merge() {
		...
		entity = new TextEntity();
		entity.setText(texts.get(0));
		entity.setDist(new byte[] { 16, 1, 0, 17, 3, 0, 3, 5 });
		when(textRepository.findByText(texts.get(0))).thenReturn(entity);
		entity = new TextEntity();
		entity.setText(texts.get(1));
		entity.setDist(new byte[] { 17, 2, 1, 4, 19, 2, 0, 1 });
		when(textRepository.findByText(texts.get(1))).thenReturn(entity);
		entity = new TextEntity();
		entity.setText(texts.get(1));
		entity.setDist(new byte[] { 7, 1, 0, 17, 1, 2, 23, 1, 0 });
		when(textRepository.findByText(texts.get(2))).thenReturn(entity);
		when(textRepository.save(any(TextEntity.class))).thenReturn(null);
		UpdateIndexRequest req = new UpdateIndexRequest();
		req.setPath(path);
	...
	public void findText_exact() {
		...
		entity.setText(text);
		entity.setDist(new byte[] { 3, 1, 11, 5, 2, 13, 17, 7, 3, 19, 23, 29 });
	...
	public void findText_contains() {
		...
		TextEntity entity = new TextEntity();
		entity.setText(text);
		entity.setDist(new byte[] { 3, 1, 11, 5, 1, 17, 7, 1, 23 });
		entities.add(entity);
		entity = new TextEntity();
		entity.setText(text);
		entity.setDist(new byte[] { 5, 1, 13, 7, 2, 19, 29 });
		entities.add(entity);
